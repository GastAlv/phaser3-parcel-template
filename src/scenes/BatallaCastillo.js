...
export default class BatallaCastillo extends Phaser.Scene
{
    ...
    create() {
        ...
        this.registry.events.on('siguiente combate', (ganador)=>{
            ...
            //Se inicia la seleccion o victoria vikingo
            (this.queEscenaSigue[ganador] === 0)?this.scene.start('VictoriaVikingo', {sonidos:this.sonidos, lenguaje:this.lenguaje}):[this.registry.events.emit('pruebaEnvio1', this.personajesActuales, this.queEscenaSigue[ganador]), this.scene.start('SeleccionPersonaje', {sonidos:this.sonidos, lenguaje: this.lenguaje})];
