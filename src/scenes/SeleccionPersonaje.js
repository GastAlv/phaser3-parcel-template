...
export default class SeleccionPersonaje extends Phaser.Scene
{
    ...
    create() {
        ...
        // this.botonAlfilSamurai = new Button(this, 1050, 542, 'seleccionAlfilSamurai', '', 0, () => {this.peleadores.push(this.#samuraiAlfil), this.botonListo2 = true}, 1, this.#samuraiAlfil, 'zoom seleccion derecha', 'resetear derecha')
        // this.botonTorreSamurai = new Button(this, 1150, 542, 'seleccionTorreSamurai', '', 0, () => {this.peleadores.push(this.#samuraiTorre), this.botonListo2 = true}, 1, this.#samuraiTorre, 'zoom seleccion derecha', 'resetear derecha')
    ...
    update(){
        ...
        if(this.actualizarPersonajes === true){
            const indice = {
                ...
                44 : this.botonReinaSamurai,
                55 : this.botonReinaSamurai,
            }
